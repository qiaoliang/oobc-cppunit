...
void Commander::readInstructions(  ){
    cout<<"input start point and direction with format: x y D"<<endl;
    getline( cin, location);
    cout<<"Input commands with format: MMMMMMM:"<<endl;
    getline( cin, commands );
}
string Commander::executeInstructions(  ){
    return send( location, commands );
}
